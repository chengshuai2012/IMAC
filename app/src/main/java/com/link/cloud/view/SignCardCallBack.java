...
import com.link.cloud.adapter.SignCardAdapter;
 ...
 */
public class SignCardCallBack extends ItemTouchHelper.SimpleCallback {
//    private SignUserdata mDatas;SignUserdata mDatas, SignAdapter adapter,
       private SignCardAdapter adapter;
    private RecyclerView mRv;

    public SignCardCallBack(RecyclerView mRv,SignCardAdapter adapter) {
        super(0,
...
//        this.mDatas = mDatas;
    ...
    public SignCardCallBack(int dragDirs, int swipeDirs) {
        super(dragDirs, swipeDirs);
    }

    public SignCardCallBack() {
        /*
...
//        MemberCard remove = mDatas.getSigndata().getMemberCard().remove(viewHolder.getLayoutPosition());
//        mDatas.getSigndata().getMemberCard().add(0, remove);
